---
name: analyze-logs
description: Analisa os logs do hermes em /Users/2a/.hermes/logs/ para identificar padrões de erro, uso e oportunidades de melhoria.
---

# Análise de Logs do hermes

## 1. Ler logs recentes

```bash
# Últimas 50 linhas de cada log
tail -50 /Users/2a/.hermes/logs/audit.log
tail -50 /Users/2a/.hermes/logs/status.log
tail -50 /Users/2a/.hermes/logs/group-blocker.log
cat /Users/2a/.hermes/logs/picowatch_stats.json
```

```bash
# Verificar se há panic logs
cat /Users/2a/.hermes/logs/launcher_panic.log 2>/dev/null && echo "PANICS ENCONTRADOS" || echo "sem panics"
```
...
- `/Users/2a/.claude/batalha/hermes-mythos/` (Node.js backend)
- Skills em `/Users/2a/.hermes/.claude/skills/`
