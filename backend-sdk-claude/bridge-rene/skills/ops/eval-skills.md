---
name: eval-skills
description: Avalia todas as skills do hermes-mythos. Testa cada uma, mede impacto, mantém as úteis e remove as obsoletas. Atualiza código legado.
---
...
```bash
find /Users/2a/.claude/batalha/hermes-mythos/backend/.claude/skills -name "*.md" | while read f; do
...
| Critério | Peso |
|----------|------|
| Relevância para o hermes-mythos | Alto |
...
- **DESCONTINUAR** — não faz sentido para o hermes-mythos atual
...
```bash
mkdir -p /Users/2a/.claude/batalha/hermes-mythos/backend/.claude/skills/_archived
mv <skill_file> /Users/2a/.claude/batalha/hermes-mythos/backend/.claude/skills/_archived/
```
